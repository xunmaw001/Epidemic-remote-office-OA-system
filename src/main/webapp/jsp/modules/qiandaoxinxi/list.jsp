                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">签到信息管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>签到信息<span class="table-project-n">列表</span></h1>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">       
                                                                                                                                                        <label>签到类型</label>
                                        <select name="qiandaoleixing" id="qiandaoleixingSelect">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="qiandaoleixingIcon" onclick="sort('qiandaoleixing')" class="fa fa-sort" aria-hidden="true"></i>签到类型</th>
																																																			<th><i id="qiandaoshijianIcon" onclick="sort('qiandaoshijian')" class="fa fa-sort" aria-hidden="true"></i>签到时间</th>
    ...
    <script>
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qiandaoxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"qiandaoxinxi");
