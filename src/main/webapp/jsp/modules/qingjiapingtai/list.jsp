                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">请假平台管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>请假平台<span class="table-project-n">列表</span></h1>
                                                ...
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="biaotiIcon" onclick="sort('biaoti')" class="fa fa-sort" aria-hidden="true"></i>标题</th>
																																																			<th><i id="neirongIcon" onclick="sort('neirong')" class="fa fa-sort" aria-hidden="true"></i>内容</th>
																																																																			<th>图片</th>
																																																			<th>
													操作
												</th>
    ...
    <script>
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var neirongCell  = document.createElement('td');
												  ...
												  //如果图文详情包含图片
				  if(item.neirong.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.neirong.indexOf('<img');
					var endIndex = item.neirong.indexOf('>');				
					neirongCell.innerHTML = item.neirong.substring(beginIndex, endIndex+1);				
				  }else{
            ...
            crossBtn1.innerHTML = "请假"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-custon-four btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"qingjiaxinxi\")");
			if(crossBtnControl('请假') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qingjiapingtai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"qingjiapingtai");
