                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">办公设备</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="all-form-element-inner">
                                                    <form id="addOrUpdateForm" action="#">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">设备编号</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">设备名称</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">数量</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
															...
															<div class="row">
																<div class="col-lg-3">
																	<label class="login2 pull-right pull-right-pro">详情</label>
																</div>	
																<div class="col-lg-9">
																	<input id="xiangqingupload" name="file" type="file">
																	<script id="xiangqingEditor" type="text/plain" style="width:650px;height:230px;"></script>
    ...
    <script>
		...
		function upload(){
						...
						dataType: 'json',
							...
							UE.getEditor('xiangqingEditor').execCommand('insertHtml','<img src=\"'+ baseUrl +'upload/'+ data.result.file + '\" width=100 height=100>');					
						}
					});
									}  
		// 表单提交
