...
<body class="materialdesign">
							...
							<div class="sparkline13-list shadow-reset">
								<div class="sparkline13-hd">
									<div class="main-sparkline13-hd">
										<h1>
											已支付订单<span class="table-project-n">列表</span>
										</h1>
										...
										<table id="table" data-toggle="table" data-resizable="true">
											<thead>
												<tr>
													...
													<th><i id="orderidIcon" onclick="sort('orderid')"
														class="fa fa-sort" aria-hidden="true"></i>订单id</th>
													<th><i id="tablenameIcon" onclick="sort('tablename')"
														class="fa fa-sort" aria-hidden="true"></i>商品表名</th>
													<th><i id="useridIcon" onclick="sort('userid')"
														class="fa fa-sort" aria-hidden="true"></i>用户id</th>
													<th><i id="goodidIcon" onclick="sort('goodid')"
														class="fa fa-sort" aria-hidden="true"></i>商品id</th>
													<th><i id="goodnameIcon" onclick="sort('goodname')"
														class="fa fa-sort" aria-hidden="true"></i>商品名称</th>
													<th><i id="pictureIcon" onclick="sort('picture')"
														class="fa fa-sort" aria-hidden="true"></i>商品图片</th>
													<th><i id="buynumberIcon" onclick="sort('buynumber')"
														class="fa fa-sort" aria-hidden="true"></i>购买数量</th>
													<th><i id="priceIcon" onclick="sort('price')"
														class="fa fa-sort" aria-hidden="true"></i>价格/积分</th>
													<th><i id="discountpriceIcon"
														onclick="sort('discountprice')" class="fa fa-sort"
														aria-hidden="true"></i>折扣价格</th>
													<th><i id="totalIcon" onclick="sort('total')"
														class="fa fa-sort" aria-hidden="true"></i>总价格/总积分</th>
													<th><i id="discounttotalIcon"
														onclick="sort('discounttotal')" class="fa fa-sort"
														aria-hidden="true"></i>折扣总价格</th>
													<th><i id="typeIcon" onclick="sort('type')"
														class="fa fa-sort" aria-hidden="true"></i>支付类型</th>
													<th><i id="statusIcon" onclick="sort('status')"
														class="fa fa-sort" aria-hidden="true"></i>状态</th>
													<th><i id="addressIcon" onclick="sort('address')"
														class="fa fa-sort" aria-hidden="true"></i>地址</th>
													<th>操作</th>
												</tr>
											</thead>
											<tbody>
	...
	<%@ include file="../../static/toLogin.jsp"%>
		...
		function setDataRow(item) {
			...
			fahuoBtn.setAttribute("class",
					"btn btn-custon-four btn-danger btn-sm 修改");
