                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">签到平台管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>签到平台<span class="table-project-n">列表</span></h1>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">       
                                                                                                                                                        <label>标题</label>
                                        <input type="text" id="biaotiSearch">
                                                ...
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="biaotiIcon" onclick="sort('biaoti')" class="fa fa-sort" aria-hidden="true"></i>标题</th>
																																																			<th><i id="xiangqingIcon" onclick="sort('xiangqing')" class="fa fa-sort" aria-hidden="true"></i>详情</th>
																																																																			<th>图片</th>
																																																			<th>
													操作
												</th>
    ...
    <script>
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var xiangqingCell  = document.createElement('td');
												  ...
												  //如果图文详情包含图片
				  if(item.xiangqing.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.xiangqing.indexOf('<img');
					var endIndex = item.xiangqing.indexOf('>');				
					xiangqingCell.innerHTML = item.xiangqing.substring(beginIndex, endIndex+1);				
				  }else{
            ...
            crossBtn1.innerHTML = "签到"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-custon-four btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"qiandaoxinxi\")");
			if(crossBtnControl('签到') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qiandaopingtai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("qiandaopingtai" + colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"qiandaopingtai");
