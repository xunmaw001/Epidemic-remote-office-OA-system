                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">收藏表管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>收藏表<span class="table-project-n">列表</span></h1>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="useridIcon" onclick="sort('userid')" class="fa fa-sort" aria-hidden="true"></i>用户id</th>
																																																			<th><i id="refidIcon" onclick="sort('refid')" class="fa fa-sort" aria-hidden="true"></i>收藏id</th>
																																																			<th><i id="tablenameIcon" onclick="sort('tablename')" class="fa fa-sort" aria-hidden="true"></i>表名</th>
																																																			<th><i id="nameIcon" onclick="sort('name')" class="fa fa-sort" aria-hidden="true"></i>收藏名称</th>
																																																																			<th>收藏图片</th>
																																																			<th>
													操作
												</th>
