...
<body class="materialdesign">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">设备申请信息管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>设备申请信息<span class="table-project-n">列表</span></h1>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">       
                                                                                                                                                                                                                                <label>设备名称</label>
                                        <input type="text" id="shebeimingchengSearch">
                                                                                                                                                                                                                                                                                                            <label>员工工号</label>
                                        <input type="text" id="yuangonggonghaoSearch">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="shebeibianhaoIcon" onclick="sort('shebeibianhao')" class="fa fa-sort" aria-hidden="true"></i>设备编号</th>
																																																			<th><i id="shebeimingchengIcon" onclick="sort('shebeimingcheng')" class="fa fa-sort" aria-hidden="true"></i>设备名称</th>
																																																			<th><i id="shuliangIcon" onclick="sort('shuliang')" class="fa fa-sort" aria-hidden="true"></i>数量</th>
																																																			<th><i id="yuangonggonghaoIcon" onclick="sort('yuangonggonghao')" class="fa fa-sort" aria-hidden="true"></i>员工工号</th>
																																																			<th><i id="yuangongxingmingIcon" onclick="sort('yuangongxingming')" class="fa fa-sort" aria-hidden="true"></i>员工姓名</th>
																																																			<th><i id="shenqingshijianIcon" onclick="sort('shenqingshijian')" class="fa fa-sort" aria-hidden="true"></i>申请时间</th>
    ...
    <script>
        ...
        var tableName = "shebeishenqingxinxi";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("shebeishenqingxinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("shebeishenqingxinxi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("shebeishenqingxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shebeishenqingxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("shebeishenqingxinxi" + colName,"GET",{
				tableName: "shebeishenqingxinxi",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
					return res.data.sum;
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shebeishenqingxinxi");
