                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">请假信息管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>请假信息<span class="table-project-n">列表</span></h1>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="biaotiIcon" onclick="sort('biaoti')" class="fa fa-sort" aria-hidden="true"></i>标题</th>
																																																			<th><i id="qingjialiyouIcon" onclick="sort('qingjialiyou')" class="fa fa-sort" aria-hidden="true"></i>请假理由</th>
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var qingjialiyouCell  = document.createElement('td');
												  ...
												  //如果图文详情包含图片
				  if(item.qingjialiyou.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.qingjialiyou.indexOf('<img');
					var endIndex = item.qingjialiyou.indexOf('>');				
					qingjialiyouCell.innerHTML = item.qingjialiyou.substring(beginIndex, endIndex+1);				
				  }else{
