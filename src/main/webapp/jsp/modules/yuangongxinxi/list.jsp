                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">员工信息管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>员工信息<span class="table-project-n">列表</span></h1>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">       
                                        ...
                                        <input type="text" id="yuangonggonghaoSearch">
                                                                                                                                                                                                                                    <label>员工姓名</label>
                                        <input type="text" id="yuangongxingmingSearch">
                                                ...
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="yuangonggonghaoIcon" onclick="sort('yuangonggonghao')" class="fa fa-sort" aria-hidden="true"></i>员工工号</th>
																																																			...
																																																			<th><i id="bumenIcon" onclick="sort('bumen')" class="fa fa-sort" aria-hidden="true"></i>部门</th>
																																																			<th><i id="gangweiIcon" onclick="sort('gangwei')" class="fa fa-sort" aria-hidden="true"></i>岗位</th>
																																																			<th><i id="lianxidianhuaIcon" onclick="sort('lianxidianhua')" class="fa fa-sort" aria-hidden="true"></i>联系电话</th>
																																																			<th><i id="shenfenzhengIcon" onclick="sort('shenfenzheng')" class="fa fa-sort" aria-hidden="true"></i>身份证</th>
																																																																			<th>照片</th>
																																																																	<th><i id="jiatingzhuzhiIcon" onclick="sort('jiatingzhuzhi')" class="fa fa-sort" aria-hidden="true"></i>家庭住址</th>
																																					<th>
													操作
												</th>
                                                </tr>
    ...
    <script>
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var gangweiCell  = document.createElement('td');

												 gangweiCell.innerHTML = item.gangwei;

                
													row.appendChild(gangweiCell);
				  ...
				  zhaopianImg.setAttribute('height','100px');
				  zhaopianImg.setAttribute('width','100px');
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yuangongxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("yuangongxinxi" + colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yuangongxinxi");
