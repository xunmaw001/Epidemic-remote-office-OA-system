                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">员工信息</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="all-form-element-inner">
                                                    <form id="addOrUpdateForm" action="#">
                                                        <input id="updateId" name="id" type="hidden">    
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                                                                                    <label class="login2 pull-right pull-right-pro">部门</label>    
                                                                                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                                                                                    <label class="login2 pull-right pull-right-pro">岗位</label>    
                                                                                                                                </div>

                                                                <div class="col-lg-2">                                                           
                                                                                                                                <input id="gangwei" name="gangwei" class="form-control" v-model="ruleForm.gangwei" readonly>
                                                                                                                                </div>
                                                            </div>
                                                        </div>
                                                                                                            <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                                                                                    <label class="login2 pull-right pull-right-pro">身份证</label>    
                                                                                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                                                                                    <label class="login2 pull-right pull-right-pro">家庭住址</label>    
                                                                                                                                </div>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yuangongxinxi/info/" + id,
