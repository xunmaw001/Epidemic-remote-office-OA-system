	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">请假平台详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">请假平台详情</a></li>
				</ul>
			</div>
		</div>
	</section>
				...
				<div class="col-lg-10 col-12 sticky-widget">
						...
						<div class="row">
							...
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									...
									<div class="form">
										<button v-for="item in buttons" @click="onCrossTap('qingjiaxinxi')" v-if="item=='请假'">请假</button>
									</div>
					...
					<div class="review">
						...
						<div :class="['review-content', hsdetail?'description-show':'review-content-show']">
							<p>内容</p>
							<div class="description" v-html="detail.neirong"></div>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	var app = new Vue({
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "qingjiapingtai"){
		...
		methods: {
			...
			getDetail(id){
				return new Promise((resolve) => {
					goodsInfo('qingjiapingtai',id, (res) => {
			...
			onCrossTap(tablename){
				...
				window.location.href = `../${tablename}/add.jsp?tablename=qingjiapingtai`
			},
		}
	})
</script>
