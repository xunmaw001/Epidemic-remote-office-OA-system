			...
			<div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input v-model="detail.shebeibianhao" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入设备编号" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input v-model="detail.shuliang" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入数量" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
	...
	var app = new Vue({
		...
		methods: {
			...
			onConfirmTap(){
				...
				this.crosstableobj.shuliang -= this.detail.shuliang
				this.updateTap(this.crosstable, this.crosstableobj)
				addFun("shebeishenqingxinxi", this.detail, (res) => {
					if(res&&res.code==0){
						alert("提交成功")
						window.history.go(-1)
					}
