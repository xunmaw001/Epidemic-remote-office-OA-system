			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">设备申请信息列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">设备申请信息列表</a></li>
						</ul>
					</div>
				</div>
			</section>
							...
							<div class="col-lg-3 col-md-7 col-12">
							    <aside>
							        <div class="widget widget-search">
							            ...
							            <form @submit.prevent="searchshebeimingchengTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="shebeimingcheng" type="text" name="s" placeholder="请输入设备名称">
			...
			methods: {
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('shebeishenqingxinxi',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
