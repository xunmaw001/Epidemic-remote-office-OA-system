	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">员工信息详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">员工信息详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									...
									<h4>部门：{{detail.bumen}}</h4>
									<h4>岗位：{{detail.gangwei}}</h4>
									<h4>联系电话：{{detail.lianxidianhua}}</h4>
									<h4>身份证：{{detail.shenfenzheng}}</h4>
									<h4>家庭住址：{{detail.jiatingzhuzhi}}</h4>
...
<script type="text/javascript">
	var app = new Vue({
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "yuangongxinxi"){
		...
		methods: {
			...
			getDetail(id){
				return new Promise((resolve) => {
					goodsInfo('yuangongxinxi',id, (res) => {
