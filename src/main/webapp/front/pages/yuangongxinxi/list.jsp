...
<html>
			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">员工信息列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">员工信息列表</a></li>
						</ul>
					</div>
				</div>
			</section>
							...
							<div class="col-lg-3 col-md-7 col-12">
							    <aside>
							        <div class="widget widget-search">
							            ...
							            <form @submit.prevent="searchyuangonggonghaoTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="yuangonggonghao" type="text" name="s" placeholder="请输入员工工号">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            <form @submit.prevent="searchyuangongxingmingTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="yuangongxingming" type="text" name="s" placeholder="请输入员工姓名">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							        </div>
							    </aside>
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				searchyuangonggonghaoTap(){
					this.page.page = 1
					this.searchname = "yuangonggonghao"
					this.searchval = this.yuangonggonghao
					this.getList(this.searchname, this.searchval)
				},
				searchyuangongxingmingTap(){
					this.page.page = 1
					this.searchname = "yuangongxingming"
					this.searchval = this.yuangongxingming
					this.getList(this.searchname, this.searchval)
				},
				onPageTap(url) {
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('yuangongxinxi',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
