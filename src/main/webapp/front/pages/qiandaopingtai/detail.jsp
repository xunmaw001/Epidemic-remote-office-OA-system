	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">签到平台详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">签到平台详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							...
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									...
									<div class="form">
										<button v-for="item in buttons" @click="onCrossTap('qiandaoxinxi')" v-if="item=='签到'">签到</button>
									</div>
...
<script type="text/javascript">
	var app = new Vue({
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "qiandaopingtai"){
		...
		methods: {
			...
			getDetail(id){
				return new Promise((resolve) => {
					goodsInfo('qiandaopingtai',id, (res) => {
			...
			onCrossTap(tablename){
				...
				window.location.href = `../${tablename}/add.jsp?tablename=qiandaopingtai`
			},
		}
	})
</script>
