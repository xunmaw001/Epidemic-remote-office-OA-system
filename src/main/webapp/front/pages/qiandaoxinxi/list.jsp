...
<html>
			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">签到信息列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">签到信息列表</a></li>
						</ul>
					</div>
				</div>
			</section>
										...
										<div class="col-lg-4 col-md-6 col-12" v-for="(item, i) in list" @click="onPageTap(`./detail.jsp?id=${item.id}`)">
											<div class="product-item">
												<div class="product-content">
													<h6><a :href="`javascript: onPageTap('./detail.jsp?id=${item.id}')`">{{item.yuangonggonghao}}</a></h6>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-lg-3 col-md-7 col-12">
							    <aside>
							        <div class="widget widget-search">
							            ...
							            <form @submit.prevent="searchqiandaoleixingTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="qiandaoleixing" type="text" name="s" placeholder="请输入签到类型">
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				searchqiandaoleixingTap(){
					this.page.page = 1
					this.searchname = "qiandaoleixing"
					this.searchval = this.qiandaoleixing
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('qiandaoxinxi',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
			...
			async created() {
				...
				var searchname = 'yuangonggonghao'
