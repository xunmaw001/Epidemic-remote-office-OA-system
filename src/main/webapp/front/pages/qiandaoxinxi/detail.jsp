	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">签到信息详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">签到信息详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									<h4>签到类型：{{detail.qiandaoleixing}}</h4>
									<h4>签到时间：{{detail.qiandaoshijian}}</h4>
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "qiandaoxinxi"){
		...
		methods: {
			...
			addCart(){
				...
				cartSave({
					...
					goodname: this.detail.yuangonggonghao,
