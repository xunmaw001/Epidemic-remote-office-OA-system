			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">办公设备列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">办公设备列表</a></li>
						</ul>
					</div>
				</div>
			</section>
										...
										<div class="col-lg-4 col-md-6 col-12" v-for="(item, i) in list" @click="onPageTap(`./detail.jsp?id=${item.id}`)">
											<div class="product-item">
												...
												<div class="product-content">
													<h6><a :href="`javascript: onPageTap('./detail.jsp?id=${item.id}')`">{{item.shebeimingcheng}}</a></h6>
												</div>
											</div>
										</div>
									</div>
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('bangongshebei',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
			...
			async created() {
				...
				var searchname = 'shebeimingcheng'
